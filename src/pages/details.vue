<template>
    <div class="details_layout">
        ...
        <div class="box">
                ...
                <ul v-show="btn_show1" class="ul_layout">
                    ...
                    <li class="li_layout" @click="show1">
                        <router-link
                            class="link"
                            replace
                            :to="`/mainpage/details?detail=${JSON.stringify(params)}`"
                        >
                            介绍
                        </router-link>
                    </li>
                    ...
                    <li class="li_layout"  @click="show3()">
                        <router-link
                            class="link"
                            replace
                            :to="`/mainpage/details/study?detail=${JSON.stringify(params)}`"
                        >
                            开始学习
                        </router-link>
                    </li>
                    ...
                    <li>
                        <el-button class="btn" type="primary" round v-show="btn_show1" @click="gostudy">
                            开始学习
                        </el-button>
                    </li>
                </ul>
            ...
            <router-link replace class="el-icon-close icon close" to="/mainpage"></router-link>
        </div>
    </div>
</template>
